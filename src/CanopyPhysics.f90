...
subroutine CalcSoilExchangeParams()
  ...
  real(kind=dp)              :: rbgselect      ! option for calculation of rbg
...
!**********************************************************************************************************************!
! function rs_zhang_df - calculate stomatal resistance for trace species
!
! Uses formulation of ...
!   Zhang, L. et al. (2003) Atmos. Chem. Phys., 3, 2067-2082.
!   Zhang, L. et al. (2002) Atmos. Environ., 36, 537-560.
! with 'rsmin' as suggested by ...
!   Wesely (1989) Atmos. Environ., 23, 1293-1304.
! and 'bvpd' as suggested by ...
!   Wolfe and Thornton (2011) Atmos. Chem. Phys., 11, 77-101.
!
!**********************************************************************************************************************!
function rs_zhang_df(mdiffl, tki, pmbi, ppfdi, srad, relhumi)
  ...
  real(kind=dp), parameter  :: brsp=196.5   ! empirical constant (umol/m2-s) for deciduous forest
...
!
!**********************************************************************************************************************!
function rml(hstarl, f0l)
  real(kind=dp), intent(in) :: hstarl  ! effective Henry's law coefficient (M/atm)
  real(kind=dp), intent(in) :: f0l     ! reactivity parameter (0-1)
  real(kind=dp)             :: rml     ! mesophyll resistance (s/cm)
  rml = 1.0_dp/((hstarl/3000.0_dp)+100.0_dp*f0l)
  return
end function rml
