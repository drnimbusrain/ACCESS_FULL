...
subroutine fgaschem(neqn, ts, y, yp )
  ...
  call RxnRates(neqn, k, y, r)
   ...
   yp(iNO3)       = -r(5)-r(6)+0.20*r(9)+r(33)+r(62)+r(80)+r(82)-r(83)-r(84)-r(85)-r(86)-r(87)-r(87)-r(88) &
                    ...
                    -r(444)-r(449)-r(456)-r(463)-r(466)-r(474)+0.15*r(476)+r(477)-r(478)
   ...
   yp(iISOPND)    = -r(40)+0.07*r(212)-r(414)-r(415)+0.70*r(478)
   yp(iISOP)      = +r(40)+r(41)+r(111)+0.7*r(141)-r(212)-r(255)-r(293)-r(331)-r(371)-r(413)
   yp(iISOPNB)    = -r(41)+0.047*r(212)-r(421)-r(422)+0.30*r(478)
...
subroutine RxnRates(neqn,k,y,r)
  ...
  real(kind=dp) :: H2, O2, N2, H2Oz
   ...
   r(65)    = k(65)*y(iO1D)*O2
   r(66)    = k(66)*y(iO1D)*N2
   r(67)    = k(67)*y(iO1D)*H2Oz
   r(68)    = k(68)*H2*y(iHO)
   r(69)    = k(69)*y(iHO)*y(iHO2)
   r(70)    = k(70)*y(iHO2)*y(iHO2)
   r(71)    = k(71)*y(iHO2)*y(iHO2)*H2Oz
...
subroutine GasPhotoRateCoeffs(ts, k)
  ...
  if (cz < mincz) then
   ...
   ! Nighttime values set to zero; daytime values mapped to output from CalcJPhoto
   ! Generated by chemgen.py from mechanism racm2_plus
   k(1)     = kphoto(jo3b)                     ! O3 + hv -> O(3P) + O2
   k(2)     = kphoto(jo3a)                     ! O3 + hv -> O(1D) + O2
   k(3)     = kphoto(jh2o2)                    ! H2O2 + hv -> 2HO
   k(4)     = kphoto(jno2)                     ! NO2 + hv -> NO + O(3P)
   k(5)     = kphoto(jno3a)                    ! NO3 + hv -> NO + O2
   k(6)     = kphoto(jno3b)                    ! NO3 + hv -> NO2 + O(3P)
   k(7)     = kphoto(jhono)                    ! HONO + hv -> HO + NO
   k(8)     = kphoto(jhno3)                    ! HNO3 + hv -> HO + NO2
   k(9)     = kphoto(jho2no2)                  ! HNO4 + hv -> products
   k(10)    = kphoto(jhchob)                   ! HCHO + hv -> CO + H2
   k(11)    = kphoto(jhchoa)                   ! HCHO + hv -> HCO + H
   k(12)    = kphoto(jch3cho)                  ! CH3CHO + hv -> CH3 + HCO
   k(13)    = kphoto(jc3h7choa)                ! n-C3H7CHO + hv -> products
   k(14)    = kphoto(jacet)                    ! CH3COCH3 + hv -> products
   k(15)    = kphoto(jacro)                    ! using CH2=CHCHO (acrolein) + hv -> products
   k(16)    = kphoto(jmek)                     ! MEK + hv -> products
   k(17)    = kphoto(jacet)                    ! using CH3COCH3 + hv -> products
   k(18)    = kphoto(jacetol)                  ! using ACETOL (hydroxyacetone) + hv -> products
   k(19)    = kphoto(jmacra) + kphoto(jmacrb)  ! MACR + hv -> two channels
   k(20)    = kphoto(jmvka) + kphoto(jmvkb)    ! MVK + hv -> two channels
   k(21)    = kphoto(jglyoxa)                  ! GLY + hv -> H2 + 2CO
   k(22)    = kphoto(jglyoxb)                  ! GLY + hv -> HCHO + CO
   k(23)    = kphoto(jglyoxc)                  ! GLY + hv -> 2HO2 + 2CO
   k(24)    = kphoto(jmglyox)                  ! MGLY + hv -> CH3CO + HCO
   k(25)    = kphoto(jmglyox)                  ! using MGLY + hv ->
   k(26)    = kphoto(jmglyox)                  ! using MGLY + hv ->
   k(27)    = kphoto(jbald)                    ! BenzALD + hv -> products
   k(28)    = kphoto(jch3ooh)                  ! CH3OOH + hv -> CH3O + OH
   k(29)    = kphoto(jch3ooh)                  ! using CH3OOH + hv ->
   k(30)    = kphoto(jpaa)                     ! CH3C(O)OOH + hv ->
   k(31)    = kphoto(jch3no3)                  ! CH3NO3 + hv -> CH3O + NO2
   k(32)    = kphoto(jpana)                    ! PAN + hv -> CH3CO(OO) + NO2
   k(33)    = kphoto(jpanb)                    ! PAN + hv -> CH3CO(O) + NO3
   k(34)    = kphoto(jtc4h9no3)/3.0            ! using t-butyl-NO3 + hv -> /3.0  
   k(35)    = kphoto(jtc4h9no3)/3.0            ! using t-butyl-NO3 + hv -> /3.0
   k(36)    = kphoto(jtc4h9no3)/3.0            ! using t-butyl-NO3 + hv -> /3.0
   k(37)    = kphoto(jtc4h9no3)/3.0            ! using t-butyl-NO3 + hv -> /3.0
   k(38)    = kphoto(jnc3h7no3)/3.0            ! using n-propyl-NO3 + hv -> /3.0
   k(39)    = kphoto(jnc3h7no3)/3.0            ! using n-propyl-NO3 + hv -> /3.0
   k(40)    = kphoto(jnc3h7no3)                ! using n-propyl-NO3 + hv ->
   k(41)    = kphoto(jtc4h9no3)/3.0            ! using t-butyl-NO3 + hv -> /3.0
   k(42)    = kphoto(jhpald)                   ! HPALD + hv -> products
   k(43)    = kphoto(jch3ooh)                  ! using CH3OOH + hv ->
   k(44)    = kphoto(jnoab)                    ! NOA + hv -> CH3CO + HCHO + NO2
   k(45)    = kphoto(jnoab)                    ! using NOA + hv ->
   k(46)    = kphoto(jnc3h7no3)/3.0            ! using n-propyl-NO3 + hv -> /3.0
   k(47)    = kphoto(jch3ooh)                  ! using CH3OOH + hv ->
   k(48)    = kphoto(jmacra) + kphoto(jmacrb)  ! using MACR + hv -> two channels
   k(49)    = kphoto(jch3ooh)                  ! using CH3OOH + hv ->
   k(50)    = kphoto(jmacra) + kphoto(jmacrb)  ! using MACR + hv -> two channels 
   k(51)    = kphoto(jacet)                    ! using CH3COCH3 + hv ->
   k(52)    = kphoto(jhoch2cho)                ! GLYC + hv -> products
   k(53)    = kphoto(jc3h7choa)                ! using n-C3H7CHO + hv ->
   k(54)    = kphoto(jpyra)                    ! CH3COCOOH + hv -> products
   k(55)    = kphoto(jch3ooh)                  ! using CH3OOH + hv -> 
   k(56)    = kphoto(jch3ooh)                  ! using CH3OOH + hv ->
   k(57)    = kphoto(jic3h7cho)                ! using i-C3H7CHO + hv ->
   k(58)    = kphoto(jnoab)                    ! using NOA + hv -> 
...
subroutine GasThermalRateCoeffs(ts, k)
  ...
  real(kind=dp) :: TEMP, AIR, N2, O2, PPA, H2Oz
  ...
  PPA = pmb(zpt)*100._dp   ! PPA = air pressure in Pascals
   ...
   ! Generated by chemgen.py from mechanism racm2_plus
   k(59)    = 1.7E-12*exp(-940./TEMP)
   k(60)    = 1.0E-14*exp(-490./TEMP)
   k(61)    = 1.4E-12*exp(-1310./TEMP)
   k(62)    = 1.4E-13*exp(-2470./TEMP)
   k(63)    = 5.6D-34*N2*(TEMP/300.)**(-2.6)*O2+6.0D-34*O2*(TEMP/300.)**(-2.6)*O2
   k(64)    = 8.0E-12*exp(-2060./TEMP)
   k(65)    = 3.2E-11*exp(-67./TEMP)
   k(66)    = 2.0E-11*exp(130./TEMP)
   k(67)    = 2.14E-10
   k(68)    = 7.70E-12*exp(-2100./TEMP)
   k(69)    = 4.8E-11*exp(250./TEMP)
   k(70)    = 2.2D-13*exp(600./TEMP)+1.90D-33*AIR*exp(980./TEMP)
   k(71)    = 3.08D-34*exp(2800./TEMP)+2.59D-54*AIR*exp(3180./TEMP)
   k(72)    = 2.9E-12*exp(-160./TEMP)
   k(73)    = TJPL(9.0D-32,1.5D0,3.0D-11,0.0D0,TEMP,AIR)
   k(74)    = TJPL(7.0D-31,2.6D0,3.6D-11,0.1D0,TEMP,AIR)
   k(75)    = 3.45E-12*exp(270./TEMP)
   k(76)    = (3.45D-12*exp(270./TEMP))*((530./TEMP)+(4.8D-6*PPA)-1.73)/100.
   k(77)    = 3.3E-39*exp(530./TEMP)
   k(78)    = 2.5E-12*exp(260./TEMP)
   k(79)    = 5.5E-12*exp(188./TEMP)
   ...
   k(83)    = 2.0E-11
   k(84)    = 4.0E-12
   k(85)    = 1.8E-11*exp(110./TEMP)
   k(86)    = 4.5E-14*exp(-1260./TEMP)
   k(87)    = 8.5E-13*exp(-2450./TEMP)
   ...
   k(96)    = 1.85E-12*exp(-1690./TEMP)
   k(97)    = 6.90E-12*exp(-1000./TEMP)
   k(98)    = 7.68E-12*exp(-370./TEMP)
   k(99)    = 1.01E-11*exp(-245./TEMP)
   k(100)   = 2.82E-11*exp(-273./TEMP)
   k(101)   = TJPL(1.0D-28,4.5D0,8.8D-12,0.85D0,TEMP,AIR)
   k(102)   = 5.72E-12*exp(500./TEMP)
   k(103)   = 1.33E-11*exp(500./TEMP)
   k(104)   = 1.48E-11*exp(448./TEMP)
   k(105)   = TJPL(5.5D-30,0.0D0,8.3D-13,-2.0D0,TEMP,AIR)
   k(106)   = 2.33E-12*exp(-193./TEMP)
   k(107)   = 1.81E-12*exp(354./TEMP)
   k(108)   = 2.31E-11
   k(109)   = 1.43E-11
   k(110)   = 1.36E-11
   k(111)   = 3.1E-11*exp(350.0/TEMP)
   k(112)   = 1.21E-11*exp(440./TEMP)
   k(113)   = 4.20E-11*exp(401./TEMP)
   k(114)   = 5.50E-12*exp(125./TEMP)
   k(115)   = 4.70E-12*exp(345./TEMP)
   k(116)   = 4.90E-12 *exp(405./TEMP)
   k(117)   = 1.39D-13+3.72D-11*exp(-2044./TEMP)
   k(118)   = 1.5E-12*exp(-90./TEMP)
   k(119)   = 2.8E-12*exp(10./TEMP)
   k(120)   = 3.0E-12
   k(121)   = 8.0E-12*exp(380.0/TEMP)
   k(122)   = 2.60E-12*exp(610./TEMP)
   k(123)   = 5.77E-12*exp(533./TEMP)
   k(124)   = 1.1E-11
   k(125)   = 9.26E-13*exp(830./TEMP)
   k(126)   = 2.8E-11*exp(175./TEMP)
   k(127)   = 2.8E-11*exp(175./TEMP)
   k(128)   = 1.00E-11
   k(129)   = 5.32E-12*exp(243./TEMP)
   k(130)   = 6.75E-12*exp(405./TEMP)
   k(131)   = 4.65E-11
   k(132)   = 2.8E-11*exp(175./TEMP)
   k(133)   = 2.05E-10
   k(134)   = 2.85E-12*exp(-345./TEMP)
   k(135)   = 3.0E-12*exp(20./TEMP)
   k(136)   = 2.6E-12*exp(200./TEMP)
   k(137)   = 1.47E-11
   k(138)   = 2.9E-12*exp(190./TEMP)
   k(139)   = 3.40E-12*exp(190./TEMP)
   k(140)   = 1.9E-11*exp(390./TEMP)
   k(141)   = 3.8E-12*exp(200./TEMP)
   k(142)   = 1.66E-11
   k(143)   = 4.5E-13
   k(144)   = 4.0E-14*exp(850./TEMP)
   k(145)   = 2.93E-12*exp(190./TEMP)
   k(146)   = 4.0E-14
   k(147)   = 4.0E-14
   k(148)   = 3.2E-11
   k(149)   = 5.31E-12*exp(-260./TEMP)
   k(150)   = 5.6E-12*exp(270./TEMP)
   k(151)   = 9.14E-15*exp(-2580./TEMP)
   k(152)   = 4.33E-15*exp(-1800./TEMP)
   k(153)   = 4.40E-15*exp(-845./TEMP)
   k(154)   = 1.34E-14*exp(-2283./TEMP)
   k(155)   = 7.86E-15*exp(-1913./TEMP)
   k(156)   = 5.0E-16*exp(-530./TEMP)
   k(157)   = 2.95E-15*exp(-783./TEMP)
   k(158)   = 1.4E-15*exp(-2100./TEMP)
   k(159)   = 8.5E-16*exp(-1520./TEMP)
   k(160)   = 1.66E-18
   k(161)   = 2.0E-16
   k(162)   = 2.0E-16
   k(163)   = 9.0E-17
   ...
   k(167)   = 1.79E-13*exp(-450./TEMP)
   k(168)   = 8.64E-13*exp(450./TEMP)
   k(169)   = 1.0E-13
   k(170)   = 1.19E-12*exp(490.0/TEMP)
   k(171)   = 1.22E-11
   k(172)   = 2.0E-12*exp(-2440./TEMP)
   k(173)   = 1.4E-12*exp(-1900./TEMP)
   k(174)   = 3.76E-12*exp(-1900./TEMP)
   k(175)   = 3.4E-15
   k(176)   = 5.02E-13*exp(-1076/TEMP)
   k(177)   = 2.90E-12*exp(-1900./TEMP)
   k(178)   = 3.76E-12*exp(-1900./TEMP)
   k(179)   = 3.78E-12
   k(180)   = 1.06E-12
   k(181)   = 2.87E-13*exp(-1000./TEMP)
   k(182)   = 2.01E-10
   k(183)   = 2.2E-14*exp(-500./TEMP)
   k(184)   = 1.0E+03
   k(185)   = 1.0E+03
   k(186)   = 1.00E+03
   k(187)   = 1.0E+03
   ...
   k(196)   = 2.80E-12*exp(300./TEMP)
   k(197)   = 2.6E-12*exp(365./TEMP)
   k(198)   = 4.00E-12
   k(199)   = 4.00E-12
   k(200)   = 4.00E-12
   k(201)   = 9.0E-12
   k(202)   = 4.00E-12
   k(203)   = 4.00E-12
   k(204)   = 2.54E-12*exp(360./TEMP)
   k(205)   = 4.0E-12
   k(206)   = 2.70E-12*exp(360./TEMP)
   k(207)   = 2.70E-12*exp(360./TEMP)
   k(208)   = 4.0E-12
   k(209)   = 2.70E-12*exp(360./TEMP)
   k(210)   = 2.70E-12*exp(360./TEMP)
   k(211)   = 2.70E-12*exp(360./TEMP)
   k(212)   = 2.70E-12*exp(360./TEMP)
   k(213)   = 4.00E-12
   k(214)   = 4.00E-12
   k(215)   = 8.1E-12*exp(270./TEMP)
   k(216)   = 8.1E-12*exp(270./TEMP)
   k(217)   = 2.9E-12*exp(300./TEMP)
   k(218)   = 4.0E-12
   k(219)   = 4.00E-12
   k(220)   = 7.5E-12*exp(290.0/TEMP)
   k(221)   = 2.54E-12*exp(360./TEMP)
   k(222)   = 2.7E-12*exp(360.0/TEMP)
   k(223)   = 2.54E-12*exp(360./TEMP)
   k(224)   = 4.0E-12
   k(225)   = 4.0E-12
   k(226)   = 2.7E-12*exp(360./TEMP)
   k(227)   = 2.7E-12*exp(360./TEMP)
   k(228)   = 4.0E-12
   k(229)   = 4.0E-12
   k(230)   = 4.00E-12
   k(231)   = 4.00E-12
   k(232)   = 4.0E-12
   k(233)   = 4.00E-12
   k(234)   = 2.7E-12*exp(360./TEMP)
   k(235)   = 4.0E-12
   k(236)   = 2.00E-11
   k(237)   = 2.00E-11
   k(238)   = 2.08E-12
   k(239)   = 4.1E-13*exp(750./TEMP)
   k(240)   = 7.5E-13*exp(700./TEMP)
   k(241)   = 1.66E-13*exp(1300./TEMP)
   k(242)   = 1.66E-13*exp(1300./TEMP)
   k(243)   = 1.66E-13*exp(1300./TEMP)
   k(244)   = 1.90E-13*exp(1300./TEMP)
   k(245)   = 1.66E-13*exp(1300./TEMP)
   k(246)   = 1.66E-13*exp(1300./TEMP)
   k(247)   = 2.91E-13*exp(1300./TEMP)
   k(248)   = 3.75E-13*exp(980./TEMP)
   k(249)   = 3.75E-13*exp(980./TEMP)
   k(250)   = 3.75E-13*exp(980./TEMP)
   k(251)   = 3.75E-13*exp(980./TEMP)
   k(252)   = 3.75E-13*exp(980./TEMP)
   k(253)   = 3.75E-13*exp(980./TEMP)
   k(254)   = 3.75E-13*exp(980./TEMP)
   k(255)   = 7.4E-13*exp(700./TEMP)
   k(256)   = 1.5E-11
   k(257)   = 1.5E-11
   k(258)   = 4.3E-13*exp(1040./TEMP)
   k(259)   = 4.3E-13*exp(1040./TEMP)
   k(260)   = 1.15E-13*exp(1300./TEMP)
   k(261)   = 1.15E-13*exp(1300./TEMP)
   k(262)   = 1.15E-13*exp(1300./TEMP)
   k(263)   = 5.2E-13*exp(980./TEMP)
   k(264)   = 1.82E-13*exp(1300./TEMP)
   k(265)   = 1.82E-13*exp(1300./TEMP)
   k(266)   = 2.91E-13*exp(1300./TEMP)
   k(267)   = 3.75E-13*exp(980./TEMP)
   k(268)   = 1.00E-11
   k(269)   = 3.75E-13*exp(980./TEMP)
   k(270)   = 1.15E-13*exp(1300./TEMP)
   k(271)   = 1.66E-13*exp(1300./TEMP)
   k(272)   = 1.66E-13*exp(1300./TEMP)
   k(273)   = 1.66E-13*exp(1300./TEMP)
   k(274)   = 1.66E-13*exp(1300./TEMP)
   k(275)   = 3.75E-13*exp(980.0/TEMP)
   k(276)   = 1.66E-13*exp(1300./TEMP)
   k(277)   = 9.5E-14*exp(390./TEMP)
   k(278)   = 1.18E-13*exp(158./TEMP)
   k(279)   = 9.46E-14*exp(431./TEMP)
   k(280)   = 1.0E-13*exp(467./TEMP)
   k(281)   = 4.34E-14*exp(633./TEMP)
   k(282)   = 1.71E-13*exp(708./TEMP)
   k(283)   = 1.46E-13*exp(708./TEMP)
   k(284)   = 9.18E-14*exp(708./TEMP)
   k(285)   = 3.56E-14*exp(708./TEMP)
   k(286)   = 3.56E-14*exp(708./TEMP)
   k(287)   = 3.56E-14*exp(708./TEMP)
   k(288)   = 3.56E-14*exp(708./TEMP)
   k(289)   = 3.56E-14*exp(708./TEMP)
   k(290)   = 3.56E-14*exp(708./TEMP)
   k(291)   = 3.56E-14*exp(708./TEMP)
   k(292)   = 3.56E-14*exp(708./TEMP)
   k(293)   = 3.4E-14*exp(221./TEMP)
   k(294)   = 3.56E-14*exp(708./TEMP)
   k(295)   = 3.56E-14*exp(708./TEMP)
   k(296)   = 2.0E-11*exp(500./TEMP)
   k(297)   = 2.0E-11*exp(500./TEMP)
   k(298)   = 7.5E-13*exp(500./TEMP)
   k(299)   = 6.91E-13*exp(508./TEMP)
   k(300)   = 6.91E-13*exp(508./TEMP)
   k(301)   = 2.0E-12*exp(500./TEMP)
   k(302)   = 3.4E-14*exp(221./TEMP)
   k(303)   = 1.38E-12
   k(304)   = 3.4E-14*exp(221./TEMP)
   k(305)   = 3.56E-14*exp(708./TEMP)
   k(306)   = 3.56E-14*exp(708./TEMP)
   k(307)   = 3.56E-14*exp(708./TEMP)
   k(308)   = 3.56E-14*exp(708./TEMP)
   k(309)   = 7.50E-13*exp(500./TEMP)
   k(310)   = 1.60E-13*exp(708./TEMP)
   k(311)   = 9.68E-14*exp(708./TEMP)
   k(312)   = 1.60E-13*exp(708./TEMP)
   k(313)   = 9.68E-14*exp(708./TEMP)
   k(314)   = 3.56E-14
   k(315)   = 5.99E-15*exp(1510./TEMP)
   k(316)   = 1.03E-12*exp(211./TEMP)
   k(317)   = 6.9E-13*exp(460./TEMP)
   k(318)   = 5.59E-13*exp(522./TEMP)
   k(319)   = 2.47E-13*exp(683./TEMP)
   k(320)   = 9.48E-13*exp(765./TEMP)
   k(321)   = 8.11E-13*exp(765./TEMP)
   k(322)   = 5.09E-13*exp(765./TEMP)
   k(323)   = 7.4E-13*exp(765./TEMP)
   k(324)   = 7.4E-13*exp(765./TEMP)
   k(325)   = 7.4E-13*exp(765./TEMP)
   k(326)   = 7.4E-13*exp(765./TEMP)
   k(327)   = 7.4E-13*exp(765./TEMP)
   k(328)   = 7.4E-13*exp(765./TEMP)
   k(329)   = 7.4E-13*exp(765./TEMP)
   k(330)   = 7.4E-13*exp(765./TEMP)
   k(331)   = 8.4E-14*exp(221./TEMP)
   k(332)   = 7.4E-13*exp(765./TEMP)
   k(333)   = 7.4E-13*exp(765./TEMP)
   k(334)   = 2.5E-12*exp(500./TEMP)
   k(335)   = 2.5E-12*exp(500./TEMP)
   k(336)   = 7.51E-13*exp(565./TEMP)
   k(337)   = 7.51E-13*exp(565./TEMP)
   k(338)   = 7.51E-13*exp(565./TEMP)
   k(339)   = 2.9E-12*exp(500./TEMP)
   k(340)   = 8.4E-14*exp(221./TEMP)
   k(341)   = 1.7E-12*exp(500./TEMP)
   k(342)   = 1.68E-12*exp(500./TEMP)
   k(343)   = 7.4E-13*exp(765./TEMP)
   k(344)   = 7.4E-13*exp(765./TEMP)
   k(345)   = 7.4E-13 *exp(708./TEMP)
   k(346)   = 7.4E-13 *exp(708./TEMP)
   k(347)   = 7.51E-13*exp(565./TEMP)
   k(348)   = 8.85E-13*exp(765./TEMP)
   k(349)   = 8.85E-13*exp(765./TEMP)
   k(350)   = 5.37E-13*exp(765./TEMP)
   k(351)   = 5.37E-13*exp(765./TEMP)
   k(352)   = 7.40E-13*exp(708./TEMP)
   k(353)   = 3.4E-14*exp(1560./TEMP)
   k(354)   = 2.50E-12*exp(500./TEMP)
   k(355)   = 1.20E-12
   k(356)   = 1.2E-12
   k(357)   = 1.20E-12
   k(358)   = 1.20E-12
   ...
   k(391)   = 1.20E-12
   k(392)   = 1.2E-12
   k(393)   = 7.00E-14*exp(1000./TEMP)
   k(394)   = 7.00E-14*exp(1000./TEMP)
   k(395)   = 4.25E-14*exp(1000./TEMP)
   k(396)   = 4.25E-14*exp(1000./TEMP)
   k(397)   = 7.00E-14*exp(1000./TEMP)
   k(398)   = 2.96E-14*exp(1000./TEMP)
   k(399)   = 2.96E-14*exp(1000./TEMP)
   k(400)   = 2.96E-14*exp(1000./TEMP)
   k(401)   = 4.25E-14*exp(1000./TEMP)
   k(402)   = 4.25E-14*exp(1000./TEMP)
   k(403)   = 1.2E-12
   k(404)   = 2.5E-12*exp(500./TEMP)
   k(405)   = 7.13E-17*exp(2950./TEMP)
   k(406)   = 4.8E-12
   k(407)   = 7.29E-11
   k(408)   = 1.67E-16
   ...
   k(411)   = 4.1E-11
   k(412)   = 1.79E-12
   k(413)   = 4.12E8*exp(-7700./TEMP)
   k(414)   = 1.77E-11*exp(500./TEMP)
   k(415)   = 9.03E-16*exp(-845./TEMP)
   k(416)   = 2.7E-12*exp(360./TEMP)
   k(417)   = 2.06E-13*exp(1300./TEMP)
   k(418)   = 7.5E-14
   k(419)   = 9.53E-14*exp(500.0/TEMP)
   k(420)   = 2.3E-12
   k(421)   = 2.43E-12*exp(500./TEMP)
   k(422)   = 5.04E-14*exp(-1800./TEMP)
   k(423)   = 2.7E-12*exp(360./TEMP)
   k(424)   = 2.06E-13*exp(1300./TEMP)
   k(425)   = 6.7E-13
   k(426)   = 8.16E-13*exp(500./TEMP)
   k(427)   = 2.3E-12
   k(428)   = 4.6E-11
   k(429)   = 5.78E-11*exp(-400./TEMP)
   k(430)   = 2.7E-12*exp(360./TEMP)
   k(431)   = 7.4E-13*exp(700./TEMP)
   k(432)   = 2.3E-12
   k(433)   = 1.0E-12
   k(434)   = 1.0E-11
   k(435)   = 7.2E-12
   k(436)   = 1.67E-11*exp(200./TEMP)
   k(437)   = 1.1E-10
   k(438)   = 4.0E-17
   k(439)   = 5.95E-12*exp(-1860./TEMP)
   k(440)   = 2.7E-12*exp(360./TEMP)
   k(441)   = 2.06E-13*exp(1300./TEMP)
   k(442)   = 8.24E-14
   k(443)   = 1.04E-13*exp(500./TEMP)
   k(444)   = 2.3E-12
   k(445)   = 7.5E-12*exp(290./TEMP)
   k(446)   = 5.2E-13*exp(980./TEMP)
   k(447)   = 8.83E-13*exp(500./TEMP)
   k(448)   = 2.9E-12 *exp(500./TEMP)
   k(449)   = 4.0E-12
   k(450)   = TJPL(9.7D-29,5.6D0,9.3D-12,1.5D0,TEMP,AIR)
   k(451)   = 2.7E-11*exp(200./TEMP)
   k(452)   = 2.7E-12*exp(360./TEMP)
   k(453)   = 2.06E-13*exp(1300./TEMP)
   k(454)   = 4.6E-13
   k(455)   = 5.8E-13*exp(500./TEMP)
   k(456)   = 2.3E-12
   k(457)   = 3.0E-12
   k(458)   = 2.0E-17
   k(459)   = 8.0E-12
   k(460)   = 2.06E-13*exp(1300./TEMP)
   k(461)   = 3.55E-12
   k(462)   = 4.23E-12*exp(500./TEMP)
   k(463)   = 2.3E-12
   k(464)   = 1.6E-12*exp(305./TEMP)
   k(465)   = 1.0E-11
   k(466)   = 1.4E-12*exp(-1860./TEMP)
   k(467)   = 1.0E-11
   k(468)   = 8.0E-13
   k(469)   = 2.9E7*exp(-5297./TEMP)
   k(470)   = 2.7E-12*exp(360./TEMP)
   k(471)   = 1.8E-13*exp(1300./TEMP)
   k(472)   = 2.04E-13
   k(473)   = 2.58E-13*exp(500./TEMP)
   k(474)   = 2.3E-12
   k(475)   = 3.8E-12*exp(200./TEMP)
   k(476)   = 5.0E-11
   k(477)   = 5.6E-12
   k(478)   = 3.15E-12*exp(-450.0/TEMP)
