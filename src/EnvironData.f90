...
module EnvironData
  ...
  private CalcTemp, CalcPressure, CalcMeanWindSpeed, CalcCair, CalcEddyDiffRa, CalcEddyDiffStull, &
          MOLength, ramol, Psi_m, Psi_h, Psi_w, CalcRiB, rav, MapRiBtoZoL, Phi
...
!**********************************************************************************************************************!
  subroutine ReadEnvironData()
    ...
    real(kind=dp)             :: xdumm    ! dummy variable not used
    ...
    read(UENV,*) sdate, stime, xdumm, takm, ts05k, ts55k, pmbm, umsm, rhm, ppfdm, sradm, &
